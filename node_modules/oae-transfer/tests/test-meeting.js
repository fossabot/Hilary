...
//     describe('Make transfer - meetings', function() {
//         /**
...
//                         assert.ok(!err);
//                         // Generate rights
//                         TransferTestUtil.generateRightMeeting(camAdminRestContext, userOrigin, stuartf, 'manager', meetings[0], function(err) {
//                             assert.ok(!err);
//                             TransferTestUtil.generateRightMeeting(camAdminRestContext, mrvisser, stuartf, 'member', meetings[0], function(err) {
//                                 assert.ok(!err);
...
//                         assert.ok(!err);
//                         // Generate rights
//                        	TransferTestUtil.generateRightMeeting(camAdminRestContext, userOrigin, userOrigin, 'manager', meetings[0], function(err) {
//                             assert.ok(!err);
//                        		TransferTestUtil.generateRightMeeting(camAdminRestContext, userOrigin, userTarget, 'member', meetings[0], function(err) {
//                                 assert.ok(!err);
//                                 TransferTestUtil.assertCreateTransferSucceeds(userOrigin.restContext, userOrigin.user.email, userTarget.user.email, userOrigin.user.id, function(transfer) {
//                                     assert.ok(transfer);
//                                     TransferTestUtil.assertMakeTransferSucceeds(userOrigin.restContext, userOrigin.user.email, transfer.code, userTarget.user.email, userTarget.user.id, function(err) {
...
//                         assert.ok(!err);
//                         // Generate rights
//                         TransferTestUtil.generateRightMeeting(camAdminRestContext, userTarget, userOrigin, 'member', meetings[0], function(err) {
//                             assert.ok(!err);
//                             TransferTestUtil.assertCreateTransferSucceeds(userOrigin.restContext, userOrigin.user.email, userTarget.user.email, userOrigin.user.id, function(transfer) {
//                                 assert.ok(transfer);
...
// 				                    	assert.ok(!err);
//                                         // Generate rights
//                                         TransferTestUtil.generateRightMeeting(camAdminRestContext, stuartf, userOrigin, 'member', meetingsStuartf[0], function(err) {
//                                             assert.ok(!err);
//                                         	TransferTestUtil.generateRightMeeting(camAdminRestContext, stuartf, userOrigin, 'manager', meetingsStuartf[1], function(err) {
//                                                 assert.ok(!err);
//                                         		TransferTestUtil.generateRightMeeting(camAdminRestContext, simong, userOrigin, 'member', meetingsSimong[0], function(err) {
//                                                     assert.ok(!err);
//                                         			TransferTestUtil.generateRightMeeting(camAdminRestContext, simong, userOrigin, 'manager', meetingsSimong[1], function(err) {
//                                                         assert.ok(!err);
//                                         				TransferTestUtil.generateRightMeeting(camAdminRestContext, mrvisser, userOrigin, 'member', meetingsMrvisser[0], function(err) {
//                                                             assert.ok(!err);
//                                         					TransferTestUtil.generateRightMeeting(camAdminRestContext, mrvisser, userOrigin, 'manager', meetingsMrvisser[1], function(err) {
//                                                                 assert.ok(!err);
//                                         						TransferTestUtil.generateRightMeeting(camAdminRestContext, orodan, userTarget, 'member', meetingsOrodan[0], function(err) {
//                                                                     assert.ok(!err);
//                                         							TransferTestUtil.generateRightMeeting(camAdminRestContext, orodan, userTarget, 'manager', meetingsOrodan[1], function(err) {
//                                                                         assert.ok(!err);
...
//                                                                             var listMeetingsBefore = [];
//                                                                             result.results.forEach(function(i) {
//                                                                                 listMeetingsBefore.push(i.id);
//                                                                             });
...
//                                                                             			RestAPI.MeetingsJitsi.getMeetingsLibrary(userTarget.restContext, userTarget.user.id, function (err, result) {
//                                                                                             var listMeetingsTargetAfter = [];
//                                                                                             result.results.forEach(function(i) {
//                                                                                                 listMeetingsTargetAfter.push(i.id);
//                                                                                             });
