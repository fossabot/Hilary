        ...
        it('verify transfer creation', function(callback) {
            TestsUtil.generateTestUsers(camAdminRestContext, 2, function(err, users, mrvisser, stuartf) {
                ...
                TransferTestUtil.assertCreateTransferSucceeds(mrvisser.restContext, mrvisser.user.email, stuartf.user.email, mrvisser.user.id, function(createdTransfer) {
                    ...
                    TransferTestUtil.assertGetTransferSucceeds(mrvisser.restContext, createdTransfer.emailOrigin, function(transfer) {
    ...
    describe('Get Transfer', function() {
        ...
        it('verify get transfer', function(callback) {
            TestsUtil.generateTestUsers(camAdminRestContext, 2, function(err, users, mrvisser, stuartf) {
                ...
                TransferTestUtil.assertCreateTransferSucceeds(mrvisser.restContext, mrvisser.user.email, stuartf.user.email, mrvisser.user.id, function(transfer) {
                    ...
                    TransferTestUtil.assertGetTransferFails(mrvisser.restContext, 'invalidemail', 400, function() {
                        // Ensure fetching using a non-existing transfer results in a 404
                        TransferTestUtil.assertGetTransferFails(mrvisser.restContext, 'nonexistingemailfortransfer@email.com', 404, function() {
        ...
        it('verify get transfer data', function(callback) {
            TestsUtil.generateTestUsers(camAdminRestContext, 2, function(err, users, mrvisser, stuartf) {
                ...
                TransferTestUtil.assertCreateTransferSucceeds(mrvisser.restContext, mrvisser.user.email, stuartf.user.email, mrvisser.user.id, function(transfer) {
                    // Sanity check that the transfer was created
                    TransferTestUtil.assertGetTransferSucceeds(mrvisser.restContext, transfer.emailOrigin, function(fetchedTransfer) {
                        // Ensure the fetched folder model is consistent with the created one
        ...
        it('verify delete transfer validation', function(callback) {
            TestsUtil.generateTestUsers(camAdminRestContext, 2, function(err, users, mrvisser, stuartf) {
                ...
                TransferTestUtil.assertCreateTransferSucceeds(mrvisser.restContext, mrvisser.user.email, stuartf.user.email, mrvisser.user.id, function(transfer) {
                    ...
                    TransferTestUtil.assertDeleteTransferSucceeds(mrvisser.restContext, transfer.emailOrigin, function() {
                        // Sanity-check it was not removed
                        TransferTestUtil.assertGetTransferFails(mrvisser.restContext, transfer.emailOrigin, 404, function(transfer) {
                            assert.ok(!transfer);
                            return callback();
                        });
                    });
        ...
        it('verify if transfer works', function(callback) {
            TestsUtil.generateTestUsers(camAdminRestContext, 2, function(err, users, mrvisser, stuartf) {
                ...
                TransferTestUtil.assertCreateTransferSucceeds(mrvisser.restContext, mrvisser.user.email, stuartf.user.email, mrvisser.user.id, function(transfer) {
                    ...
                    assert.ok(transfer);
                    // Wrong code
                    TransferTestUtil.assertMakeTransferFails(stuartf.restContext, mrvisser.user.email, 'wrongTransferCode', stuartf.user.email, stuartf.user.id, 403, function(){
                        // Invalid email origin
                        TransferTestUtil.assertMakeTransferFails(stuartf.restContext, 'invalideEmail', transfer.code, stuartf.user.email, stuartf.user.id, 402, function(){
                            // Empty email
                            TransferTestUtil.assertMakeTransferFails(stuartf.restContext, '', transfer.code, stuartf.user.email, stuartf.user.id, 400, function(){
                                // Empty code
                                TransferTestUtil.assertMakeTransferFails(stuartf.restContext, mrvisser.user.email, '', stuartf.user.email, stuartf.user.id, 401, function(){
                                    // Wrong email origin email
                                    TransferTestUtil.assertMakeTransferFails(stuartf.restContext, 'wrongemail@email.com', transfer.code, stuartf.user.email, stuartf.user.id, 404, function(){
                                        // There is no data to transfer
                                        TransferTestUtil.assertMakeTransferFails(stuartf.restContext, mrvisser.user.email, transfer.code, stuartf.user.email, stuartf.user.id, 405, function(){
                                            TransferTestUtil.generateDiscussions(mrvisser.restContext, 'private', function(err, mrvisserdoc1, mrvisserdoc2, mrvisserdoc3){
                                                ...
                                                TransferTestUtil.assertMakeTransferSucceeds(stuartf.restContext, mrvisser.user.email, transfer.code, stuartf.user.email, stuartf.user.id, function(err){
                                                    ...
                                                    TransferTestUtil.assertGetTransferFails(mrvisser.restContext, transfer.emailOrigin, 404, function() {
                                                        return callback();
                                                    });
                                                });
                                            });
