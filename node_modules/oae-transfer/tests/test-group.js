...
describe('Transfer-group', function() {
    ...
    describe('Make transfer - group', function() {
        /**
        ...
        it('verify if transfer find good manager', function(callback) {
            ...
            TestsUtil.generateTestUsers(camAdminRestContext, 3, function(err, users, mrvisser, stuartf, userOrigin) {
                ...
                TestsUtil.generateTestUsers(gtAdminRestContext, 1, function(err, users, userTarget) {
                    assert.ok(!err);
                    // Generate group
                    RestAPI.Group.createGroup(mrvisser.restContext, 'Group title', 'Group description', 'private', 'yes', [userOrigin.user.email], [stuartf.user.email], function(err, group) {
                        assert.ok(!err);
