...
var generateFiles = module.exports.generateFiles = function(restCtx, privacy, callback) {
    RestAPI.Content.createFile(restCtx, 'name', 'description', privacy, getFileStream, null, null, null, function(err, file1) {
        assert.ok(!err);
        RestAPI.Content.createFile(restCtx, 'name', 'description', privacy, getFileStream, null, null, null, function(err, file2) {
            assert.ok(!err);
            RestAPI.Content.createFile(restCtx, 'name', 'description', privacy, getFileStream, null, null, null, function(err, file3) {
                assert.ok(!err);
...
var generateFile = module.exports.generateFile = function(restCtx, privacy, callback) {
    RestAPI.Content.createFile(restCtx, 'name', 'description', privacy, getFileStream, null, null, null, function(err, file) {
        assert.ok(!err);
        callback(null, file);
    });
};
...
/*var generateCollabdocs = module.exports.generateCollabdocs = function(restCtx, privacy, callback) {
    RestAPI.Content.createCollabDoc(restCtx, 'name', 'description', privacy, null, null, null, null, function(err, collab1) {
        assert.ok(!err);
        RestAPI.Content.createCollabDoc(restCtx, 'name', 'description', privacy, null, null, null, null, function(err, collab2) {
            assert.ok(!err);
            RestAPI.Content.createCollabDoc(restCtx, 'name', 'description', privacy, null, null, null, null, function(err, collab3) {
                assert.ok(!err);
...
var generateCollabdoc = module.exports.generateCollabdoc = function(mrvisser, privacy, callback) {
    var userIds = _.keys(mrvisser);
    RestAPI.Content.createCollabDoc(mrvisser.restContext, 'name', 'description', privacy, userIds, null, null, null, function(err, collab) {
        console.log(err);
        assert.ok(!err);
...
var generateRightContent = module.exports.generateRightContent = function(owner, contributor, right, content, callback){
    ...
    ContentTestUtil.assertUpdateContentMembersSucceeds(owner.restContext, owner.restContext, content.id, memberUpdates, function() {
