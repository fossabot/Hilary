...
var createTransfer = module.exports.createTransfer = function (ctx, emailOrigin, emailTarget, idUserOrigin, callback) {    
    ...
    _getTimelifeTransfer(ctx, function (err, timelife){
        ...
        Cassandra.runQuery('INSERT INTO "Transfer" ("emailOrigin", "code", "emailTarget", "idUserOrigin") VALUES (?, ?, ?, ?) USING TTL ?', [emailOrigin, code, emailTarget, idUserOrigin, finalTimelife], function(err, result) {
            if (err) {
                return callback(err);
            }
        });
