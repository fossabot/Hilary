 ...
 * @param  {Object}     callback.err    An error that occurred, if any
 */
var removeMeetingFromLibrary = module.exports.removeMeetingFromLibrary = function (ctx, libraryOwnerId, meetingId, deleteUser, callback) {
    ...
    _getMeeting(meetingId, function (err, meeting) {
        ...
        PrincipalsDAO.getPrincipal(libraryOwnerId, function (err, principal) {
            ...
            AuthzPermissions.canRemoveRole(ctx, principal, meeting, deleteUser, function (err, memberChangeInfo) {
                if (err) {
                    return callback(err);
                }
