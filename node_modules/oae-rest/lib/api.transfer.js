 ...
 * @param  {String}         emailOrigin             The user email
 * @param  {String}         emailTarget             The new email
 ...
 */
var createTransfer = module.exports.createTransfer = function(RestContext, idUserOrigin, emailOrigin, emailTarget, callback){
    var params = {
 ...
 * @param  {Transfer}       callback.transfer       The transfer that was created
 */
var getTransferById = module.exports.getTransferById = function(RestContext, idUserOrigin, callback){
    RestUtil.RestRequest(RestContext, '/api/transfer/getTransferById/'+ RestUtil.encodeURIComponent(idUserOrigin), 'get', {'idUserOrigin' : idUserOrigin} , function(err, transfer){
        if (err) {
            return callback(err);
        }
        return callback(null, transfer);
 ...
 * @param  {String}         emailTarget             The new email
 * @param  {String}         idUserTarget            The id new user
 * @param  {Function}       callback                Standard callback function
 * @param  {Object}         callback.err            An error that occurred, if any
 * @param  {Transfer}       callback.transfer       The transfer that was created
 */
var makeTransfer = module.exports.makeTransfer = function(RestContext, emailOrigin, code, emailTarget, idUserTarget, callback){
    var params = {
        'emailOrigin': emailOrigin,
        'code': code,
        'emailTarget': emailTarget,
 ...
 * @param  {String}         emailOrigin             The user email
 * @param  {String}         code                    The generated code
 * @param  {String}         idUserOrigin            The id user
 * @param  {Function}       callback                Standard callback function
 * @param  {Object}         callback.err            An error that occurred, if any
 * @param  {Transfer}       callback.transfer       The transfer that was created
 */
var deleteTransfer = module.exports.deleteTransfer = function(RestContext, emailOrigin, code, idUserOrigin, callback){
    var params = {
        'emailOrigin': emailOrigin,
        'code': code,
        'idUserOrigin': idUserOrigin
