...
var PrincipalsAPI = require('oae-principals/lib/api.group');
 ...
 * @param  {Object}         callback.err        An error that occurred, if any
 */
var removeFolderFromLibrary = module.exports.removeFolderFromLibrary = function(ctx, principalId, folderId, deleteUser, callback) {
    var validator = new Validator();
    ...
    FoldersDAO.getFolder(folderId, function(err, folder) {
        ...
        PrincipalsDAO.getPrincipal(principalId, function(err, principal) {
            ...
            AuthzPermissions.canRemoveRole(ctx, principal, folder, deleteUser, function(err, memberChangeInfo) {
                if (err) {
                    return callback(err);
                }
