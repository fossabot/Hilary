 ...
 * @param  {Object}     callback.err    An error that occurred, if any
 */
var removeContentFromLibrary = module.exports.removeContentFromLibrary = function(ctx, libraryOwnerId, contentId, deleteUser, callback) {
    var validator = new Validator();
    ...
    ContentDAO.Content.getContent(contentId, function(err, content) {
        ...
        PrincipalsDAO.getPrincipal(libraryOwnerId, function(err, libraryOwner) {
            ...
            AuthzPermissions.canRemoveRole(ctx, libraryOwner, content, deleteUser, function(err, memberChangeInfo) {
