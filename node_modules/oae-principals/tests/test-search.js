...
//                                     assert.equal(_.keys(userDoc.tenant).length, 3);
...
//                                         assert.equal(_.keys(groupDoc.tenant).length, 3);
...
//                                         SearchTestsUtil.searchAll(user.restContext, 'members-library', [group.id], null, function(err, results) {
//                                             assert.ok(!err);
//                                             assert.ok(_getDocById(results, user.user.id));
