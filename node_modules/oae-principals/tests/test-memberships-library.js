...
//                     PrincipalsTestUtil.assertGetAllMembershipsLibrarySucceeds(simon.restContext, branden.user.id, null, function(membershipsBefore) {
...
//                             PrincipalsTestUtil.assertGetAllMembershipsLibrarySucceeds(simon.restContext, branden.user.id, null, function(membershipsAfter) {
...
//                         PrincipalsTestUtil.assertGetAllMembershipsLibrarySucceeds(simon.restContext, branden.user.id, null, function(memberships) {
...
//                             PrincipalsTestUtil.assertGetAllMembershipsLibrarySucceeds(publicTenant1.publicUser.restContext, publicTenant1.publicUser.user.id, null, function(memberships) {
...
//                                 PrincipalsTestUtil.assertGetAllMembershipsLibrarySucceeds(publicTenant1.adminRestContext, publicTenant1.publicUser.user.id, null, function(memberships) {
//                                     _assertArraysEqual(expectedPrivateFeed, _.pluck(memberships, 'id'));

//                                     // Ensure the global admin can see all groups in the memberships library feed
//                                     PrincipalsTestUtil.assertGetAllMembershipsLibrarySucceeds(globalAdminOnTenantRestContext, publicTenant1.publicUser.user.id, null, function(memberships) {
//                                         _assertArraysEqual(expectedPrivateFeed, _.pluck(memberships, 'id'));

//                                         // Ensure a user from the same tenant can see loggedin feed
//                                         PrincipalsTestUtil.assertGetAllMembershipsLibrarySucceeds(publicTenant1.loggedinUser.restContext, publicTenant1.publicUser.user.id, null, function(memberships) {
//                                             _assertArraysEqual(expectedLoggedinFeed, _.pluck(memberships, 'id'));

//                                             // Ensure anonymous user gets the public feed
//                                             PrincipalsTestUtil.assertGetAllMembershipsLibrarySucceeds(publicTenant1.anonymousRestContext, publicTenant1.publicUser.user.id, null, function(memberships) {
//                                                 _assertArraysEqual(expectedPublicFeed, _.pluck(memberships, 'id'));

//                                                 // Ensure user from another tenant gets the public feed
//                                                 PrincipalsTestUtil.assertGetAllMembershipsLibrarySucceeds(publicTenant2.publicUser.restContext, publicTenant1.publicUser.user.id, null, function(memberships) {
//                                                     _assertArraysEqual(expectedPublicFeed, _.pluck(memberships, 'id'));

//                                                     // Ensure tenant admin from another tenant gets the public feed
//                                                     PrincipalsTestUtil.assertGetAllMembershipsLibrarySucceeds(publicTenant2.adminRestContext, publicTenant1.publicUser.user.id, null, function(memberships) {
//                                                         _assertArraysEqual(expectedPublicFeed, _.pluck(memberships, 'id'));
//                                                         return callback();
//                                                     });
//                                                 });
