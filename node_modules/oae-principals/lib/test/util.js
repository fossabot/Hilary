 ...
 * @throws {AssertionError}                     Thrown if there is an issue deleting the groups or any of the assertions fail
 */
var assertDefinitiveDeletionUsersSucceeds = module.exports.assertDefinitiveDeletionUsersSucceeds = function(deleterRestCtx, deletedUser, callback) {
    PrincipalsAPIUser._definitiveDeletion(deleterRestCtx, deletedUser.user, function(err){
        assert.ok(!err);
    ...
    RestAPI.Content.createCollabDoc(restCtx, 'name', 'description', privacy, [], [], [], [], function(err, collab1) {
        ...
        RestAPI.Content.createCollabDoc(restCtx, 'name', 'description', privacy, [], [], [], [], function(err, collab2) {
            ...
            RestAPI.Content.createCollabDoc(restCtx, 'name', 'description', privacy, [], [], [], [], function(err, collab3) {
                assert.ok(!err);
                RestAPI.Content.createCollabDoc(restCtx, 'name', 'description', privacy, [], [], [], [], function(err, collab4) {
                    assert.ok(!err);
                    return callback(null, collab1, collab2, collab3, collab4);
                });
            });
        });
    });
...
var generateFiles = module.exports.generateFiles = function(restCtx, privacy, callback) {
    RestAPI.Content.createFile(restCtx, 'name', 'description', privacy, _getPictureStream(), null, null, null, function(err, file1) {
        assert.ok(!err);
        RestAPI.Content.createFile(restCtx, 'name', 'description', privacy, _getPictureStream(), null, null, null, function(err, file2) {
            assert.ok(!err);
            RestAPI.Content.createFile(restCtx, 'name', 'description', privacy, _getPictureStream(), null, null, null, function(err, file3) {
                assert.ok(!err);
                return callback(null, file1, file2, file3);
            });
        });
    });
};
    ...
    RestAPI.Discussions.createDiscussion(restCtx, 'name', 'description', privacy, null, null, function(err, discussion1) {
        ...
        RestAPI.Discussions.createDiscussion(restCtx, 'name', 'description', privacy, null, null, function(err, discussion2) {
            ...
            RestAPI.Discussions.createDiscussion(restCtx, 'name', 'description', privacy, null, null, function(err, discussion3) {
                assert.ok(!err);
                return callback(null, discussion1, discussion2, discussion3);
            });
        });
    });
};
    ...
    RestAPI.Content.createLink(restCtx, 'name', 'description', privacy, 'google.com', null, null, null, function(err, link1) {
        ...
        RestAPI.Content.createLink(restCtx, 'name', 'description', privacy, 'google.com', null, null, null, function(err, link2) {
            ...
            RestAPI.Content.createLink(restCtx, 'name', 'description', privacy, 'google.com', null, null, null, function(err, link3) {
                assert.ok(!err);
                return callback(null, link1, link2, link3);
            });
        });
    });
};
