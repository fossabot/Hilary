...
var generateFolders = module.exports.generateFolders = function(user, privacy, numToCreate, callback, _created) {
    ...
    FolderTestUtil.assertCreateFolderSucceeds(user.restContext, 'name', 'description', privacy, [user], [], function(err, folder) {
        assert.ok(!err);
 ...
 * @param  {String}             contributor     The user
 * @param  {String}             right           The right to attribute to the user
 * @param  {String}             meeting      The meeting to update
 * @param  {Function}           callback        Standard callback function
 * @throws {AssertionError}                     Thrown if the request failed
 */
...
var generateRightFolder = module.exports.generateRightFolder = function(owner, contributor, right, folder, callback) {
    var memberUpdates = {};
    memberUpdates[contributor.user.id] = right;
    FolderTestUtil.assertUpdateFolderMembersSucceeds(owner.restContext, contributor.restContext, folder.id, memberUpdates, function(err) {
        assert.ok(!err);
