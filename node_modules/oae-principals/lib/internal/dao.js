...
var addDataToArchive = module.exports.addDataToArchive = function(archiveId, principalId, resourceId, callback) {
    ...
    resourceId.forEach(function(element, id, arr) {
        queries.push({'query': 'INSERT INTO "DataArchive" ("archiveId", "principalId", "resourceId") VALUES (?, ?, ?)', 'parameters': [archiveId, principalId, element]});  
