...
var _ensureSchema = function(callback) {
    ...
    Cassandra.createColumnFamilies({
        ...
        // 
        'ArchiveByTenant': 'CREATE TABLE "ArchiveByTenant" ("aliasTenant" text PRIMARY KEY, "idArchive" text)',

        // 
        'DataArchive': 'CREATE TABLE "DataArchive" ("idArchive" text, "principalId" text, "idResources" text, PRIMARY KEY ("idArchive", "principalId", "idResources"))'
